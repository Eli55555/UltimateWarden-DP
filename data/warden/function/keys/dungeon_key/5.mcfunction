...
execute if score ultimatewarden warden_dungeon_activated matches 0 run execute in warden:ultimatewarden run execute positioned 48.13 -162.00 34.77 run kill @e[distance=..150,type=!player]
execute if score ultimatewarden warden_dungeon_activated matches 0 run execute in warden:ultimatewarden run execute positioned 48.13 -162.00 34.77 run kill @e[distance=..150,type=item]

execute if score ultimatewarden warden_dungeon_activated matches 0 run execute in warden:ultimatewarden run place template warden:dungeon.01 0 -112 0
execute if score ultimatewarden warden_dungeon_activated matches 0 run execute in warden:ultimatewarden run place template warden:dungeon.02 48 -112 0
execute if score ultimatewarden warden_dungeon_activated matches 0 run execute in warden:ultimatewarden run place template warden:dungeon.03 48 -112 48
execute if score ultimatewarden warden_dungeon_activated matches 0 run execute in warden:ultimatewarden run place template warden:dungeon.04 0 -112 48
