...
execute if score ultimatewarden warden_dungeon_activated matches 1 run execute in warden:ultimatewarden run place template warden:dungeon.bossroom -29 -82 82 180
execute if entity @a[tag=warden_dungeon_boss_key] run execute in warden:ultimatewarden run tp @a[tag=uw.dungeon] -32 -80 70
execute if entity @a[tag=warden_dungeon_boss_key] run execute in warden:ultimatewarden run spawnpoint @a[tag=uw.dungeon] -32 -80 70
...
execute if entity @a[tag=warden_dungeon_boss_key] run advancement grant @a[tag=uw.dungeon] only warden:warden/bossroom_enter
