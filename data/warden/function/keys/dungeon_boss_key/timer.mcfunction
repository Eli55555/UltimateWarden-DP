...
execute as @a if items entity @s weapon.mainhand minecraft:nautilus_shell[minecraft:custom_data~{warden.keys.dungeon.boss_key:1b}] run tag @s add warden.key.dungeon.boss_key
