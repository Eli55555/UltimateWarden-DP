...
execute if score ultimatewarden warden.dungeon.activated matches 1 run execute in warden:ultimatewarden run place template warden:dungeon.boss.room -29 78 82 180
...
execute if score ultimatewarden warden.dungeon.activated matches 2 run schedule function warden:dungeon/boss/fight/spawn_boss 1s
