...
# Temple generate
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.01 -146 146 -74
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.02 -194 146 -74
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.03 -194 146 -26
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.04 -146 146 -26
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.05 -146 98 -74
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.06 -194 98 -74
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.07 -194 98 -26
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.08 -146 98 -26
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.09 -146 50 -74
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.10 -194 50 -74
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.11 -194 50 -26
execute if score ultimatewarden warden_temple_activated matches 0 run execute in warden:ultimatewarden run place template warden:temple.12 -146 50 -26
