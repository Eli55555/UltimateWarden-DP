...
execute if entity @a[tag=warden_WIP_key] run tellraw @a[tag=warden_WIP_key] [{"text":"[Ultimate Warden] ","bold":true,"color":"blue"},{"translate":"ultimate_warden.wip_key.massage.1","fallback":"You will leave the temple in 10 seconds...","color":"dark_red",bold:false}]
