...
scoreboard players add ultimatewarden warden.temple.floor3.ancient_ring.phase2.wave 0
...
scoreboard players add ultimatewarden warden.temple.floor3.ancient_warden.idle_animation 0
