...
execute if score ultimatewarden warden.temple.floor3.ancient_ring matches 2 if score ultimatewarden warden.temple.floor3.ancient_ring.phase1.timer matches 100 run scoreboard players set ultimatewarden warden.temple.floor3.ancient_ring.phase1.timer 0
