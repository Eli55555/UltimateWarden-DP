...
execute in warden:ultimatewarden as @e[tag=ancient_ring,limit=1] at @s run advancement grant @a[distance=..40,tag=warden.temple] only warden:warden/temple/ancient_ring_bossfight
