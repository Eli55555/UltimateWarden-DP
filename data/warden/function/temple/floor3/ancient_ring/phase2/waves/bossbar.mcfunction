...
execute if score ultimatewarden warden.temple.floor3.ancient_ring.phase2.wave matches 7 in warden:ultimatewarden run attribute @e[type=armor_stand,tag=warden.temple.floor3.ancient_ring.phase2.wave.bossbar,limit=1] max_health base set 56
