...
$execute in warden:ultimatewarden run summon parched $(x) $(y) $(z) {PersistenceRequired:true,Tags:["warden.temple.floor3.ancient_ring.phase2.wave$(wave).mob","warden.temple.floor3.ancient_ring.phase2.wave.mob","warden.temple.floor3.ancient_ring.phase2.wave.mob.replace_lantern.$(lantern_replace)"],equipment:{mainhand:{id:"minecraft:bow",components:{enchantments:{power:5,quick_charge:3}}}},attributes:[{id:"max_health",base:44}],Health:44}
