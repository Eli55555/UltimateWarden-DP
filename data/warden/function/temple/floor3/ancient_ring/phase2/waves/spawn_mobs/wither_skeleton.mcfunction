...
$execute in warden:ultimatewarden run summon wither_skeleton $(x) $(y) $(z) {PersistenceRequired:true,Tags:["warden.temple.floor3.ancient_ring.phase2.wave$(wave).mob","warden.temple.floor3.ancient_ring.phase2.wave.mob","warden.temple.floor3.ancient_ring.phase2.wave.mob.replace_lantern.$(lantern_replace)"],equipment:{mainhand:{id:"minecraft:netherite_sword",components:{enchantments:{sharpness:5,fire_aspect:2}}}},attributes:[{id:"max_health",base:50}],Health:50}
