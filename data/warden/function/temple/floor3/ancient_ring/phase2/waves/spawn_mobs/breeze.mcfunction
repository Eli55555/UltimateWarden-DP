...
$execute in warden:ultimatewarden run summon breeze $(x) $(y) $(z) {PersistenceRequired:true,Tags:["warden.temple.floor3.ancient_ring.phase2.wave$(wave).mob","warden.temple.floor3.ancient_ring.phase2.wave.mob","warden.temple.floor3.ancient_ring.phase2.wave.mob.replace_lantern.$(lantern_replace)"],attributes:[{id:"max_health",base:55}],Health:55}
