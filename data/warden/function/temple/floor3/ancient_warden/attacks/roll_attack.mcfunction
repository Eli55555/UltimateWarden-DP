...
#execute positioned as @e[type=armor_stand,tag=warden.temple.ancient_warden.roll] in warden:ultimatewarden if block ~ ~-1 ~ orange_concrete if entity @e[type=warden,tag=ancient_warden,limit=1] run function warden:temple/floor3/ancient_warden/attacks/ring_throw/main
