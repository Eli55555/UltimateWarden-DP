...
execute in warden:ultimatewarden if entity @e[tag=warden.ancient_warden.attacks.ring_throw,limit=1] run schedule function warden:temple/floor3/ancient_warden/attacks/ring_throw/1 1s
