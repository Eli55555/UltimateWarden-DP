...
execute as @e[tag=warden.ancient_warden.root] run function warden:ancient_warden/animations/ring_idle/play_exclusive
function warden:temple/floor3/ancient_warden/attacks/roll_attack
