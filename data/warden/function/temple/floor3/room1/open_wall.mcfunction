scoreboard players set ultimatewarden warden.temple.floor3.guard 3
...
execute in warden:ultimatewarden positioned -151 68 -52 run playsound entity.generic.explode block @a[distance=..50] -151 68 -52 10
