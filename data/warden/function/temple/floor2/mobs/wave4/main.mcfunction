execute if score ultimatewarden warden.temple.floor2.timer matches 58 run execute in warden:ultimatewarden run title @a[tag=uw.temple] actionbar {"text":"Wave 4","color":"dark_red"}
...
execute if score ultimatewarden warden.temple.floor2.timer matches 58 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=uw.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 73 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=uw.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 82 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=uw.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 91 run execute in warden:ultimatewarden run summon wither_skeleton -166 111 -6 {Health:30,attributes:[{id:max_health,base:30f}],Tags:["warden.temple.floor.2.mob"],equipment:{mainhand:{id:"minecraft:netherite_sword",count:1}}}
execute if score ultimatewarden warden.temple.floor2.timer matches 91 run execute in warden:ultimatewarden run summon wither_skeleton -166 111 -6 {Health:30,attributes:[{id:max_health,base:30f}],Tags:["warden.temple.floor.2.mob"],equipment:{mainhand:{id:"minecraft:netherite_sword",count:1}}}
execute if score ultimatewarden warden.temple.floor2.timer matches 91 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=uw.temple]
