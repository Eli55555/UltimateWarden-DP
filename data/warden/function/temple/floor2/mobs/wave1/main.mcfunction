execute if score ultimatewarden warden.temple.floor2.timer matches 1 run execute in warden:ultimatewarden run title @a[tag=warden.temple] actionbar {"text":"Wave 1","color":"dark_red"}
...
execute if score ultimatewarden warden.temple.floor2.timer matches 1 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=warden.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 2 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=warden.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 3 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=warden.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 4 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=warden.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 7 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=warden.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 10 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=warden.temple]
