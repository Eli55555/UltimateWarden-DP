execute if score ultimatewarden warden.temple.floor2.timer matches 93 run execute in warden:ultimatewarden run title @a[tag=uw.temple] actionbar {"text":"Wave 5","color":"dark_red"}
