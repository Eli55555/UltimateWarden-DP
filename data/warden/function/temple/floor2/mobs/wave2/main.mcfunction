execute if score ultimatewarden warden.temple.floor2.timer matches 12 run execute in warden:ultimatewarden run title @a[tag=uw.temple] actionbar {"text":"Wave 2","color":"dark_red"}
...
execute if score ultimatewarden warden.temple.floor2.timer matches 12 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=uw.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 21 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=uw.temple]
...
execute if score ultimatewarden warden.temple.floor2.timer matches 30 run execute in warden:ultimatewarden run playsound minecraft:block.trial_spawner.spawn_mob master @a[tag=uw.temple]
