advancement revoke @s only warden:warden/skins/use_warden_axe_skin
...
execute if entity @s[nbt={equipment:{offhand:{id:"minecraft:nautilus_shell",components:{"minecraft:custom_data":{warden_axe_skin:1b}}}}}] run execute if entity @s[nbt={SelectedItem:{id:"minecraft:iron_axe"}}] run function warden:skins/warden_axe_skin_apply
