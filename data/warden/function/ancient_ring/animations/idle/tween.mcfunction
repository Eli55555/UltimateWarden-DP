...
tag @s add warden.ancient_ring.animation.idle.playing
...
execute at @s run function warden:ancient_ring/animations/idle/zzz/apply_frame {frame: 0}
$execute at @s run function warden:ancient_ring/animations/idle/zzz/apply_frame {frame: $(to_frame)}
