...
tag @s add warden.ancient_warden.animation.walk.playing
...
execute at @s run function warden:ancient_warden/animations/walk/zzz/apply_frame {frame: 0}
$execute at @s run function warden:ancient_warden/animations/walk/zzz/apply_frame {frame: $(to_frame)}
