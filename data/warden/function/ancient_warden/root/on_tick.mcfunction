...
execute if entity @s[tag=warden.ancient_warden.animation.ring_idle.playing] run function warden:ancient_warden/animations/ring_idle/zzz/on_tick
...
execute if entity @s[tag=warden.ancient_warden.animation.shield_loop.playing] run function warden:ancient_warden/animations/shield_loop/zzz/on_tick
