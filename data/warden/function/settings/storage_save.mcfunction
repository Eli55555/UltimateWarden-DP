...
# Bossbar Amount
execute if score ultimatewarden warden.settings.bossbar_amount matches ..5 run data merge storage warden:settings {bossbar_amount:[{id:"5",display:{"text":"5","color":"green"}},{id:"10",display:{"text":"10","color":"green"}},{id:"15",display:{"text":"15","color":"yellow"}},{id:"20",display:{"text":"20","color":"yellow"}},{id:"25",display:{"text":"25","color":"red"}}]}
execute if score ultimatewarden warden.settings.bossbar_amount matches 6..10 run data merge storage warden:settings {bossbar_amount:[{id:"10",display:{"text":"10","color":"green"}},{id:"15",display:{"text":"15","color":"yellow"}},{id:"20",display:{"text":"20","color":"yellow"}},{id:"25",display:{"text":"25","color":"red"}},{id:"5",display:{"text":"5","color":"green"}}]}
execute if score ultimatewarden warden.settings.bossbar_amount matches 11..15 run data merge storage warden:settings {bossbar_amount:[{id:"15",display:{"text":"15","color":"yellow"}},{id:"20",display:{"text":"20","color":"yellow"}},{id:"25",display:{"text":"25","color":"red"}},{id:"5",display:{"text":"5","color":"green"}},{id:"10",display:{"text":"10","color":"green"}}]}
execute if score ultimatewarden warden.settings.bossbar_amount matches 16..20 run data merge storage warden:settings {bossbar_amount:[{id:"20",display:{"text":"20","color":"yellow"}},{id:"25",display:{"text":"25","color":"red"}},{id:"5",display:{"text":"5","color":"green"}},{id:"10",display:{"text":"10","color":"green"}},{id:"15",display:{"text":"15","color":"yellow"}}]}
execute if score ultimatewarden warden.settings.bossbar_amount matches 21.. run data merge storage warden:settings {bossbar_amount:[{id:"25",display:{"text":"25","color":"red"}},{id:"5",display:{"text":"5","color":"green"}},{id:"10",display:{"text":"10","color":"green"}},{id:"15",display:{"text":"15","color":"yellow"}},{id:"20",display:{"text":"20","color":"yellow"}}]}
