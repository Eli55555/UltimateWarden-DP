...
execute in warden:ultimatewarden run tp @e[tag=elite_warden] -62 80 49
execute as @e[tag=elite_warden] run effect give @s levitation 3 1 true

execute if entity @e[tag=elite_warden] run schedule function warden:dungeon/boss/fight/lightning_attack/3 50t
