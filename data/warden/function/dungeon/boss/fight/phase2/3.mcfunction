execute in warden:ultimatewarden run fill -52 -78 59 -31 -77 80 minecraft:lava replace air
execute in warden:ultimatewarden run fill -52 -78 59 -31 -77 80 minecraft:lava replace sculk_vein
