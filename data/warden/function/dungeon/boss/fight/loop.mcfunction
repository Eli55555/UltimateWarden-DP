...
execute if score ultimatewarden warden.ultimate_warden matches 1 run execute in warden:ultimatewarden run tp @e[tag=ultimate_warden] -43.00 84 70.00
...
execute if score ultimatewarden warden.ultimate_warden matches 2 run execute in warden:ultimatewarden run execute positioned -43.00 84 70.00 run particle minecraft:sculk_soul ~ ~ ~ 8 8 8 0.1 2000
