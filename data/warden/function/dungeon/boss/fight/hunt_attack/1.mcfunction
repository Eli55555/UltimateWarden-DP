...
execute as @e[tag=elite_warden] at @s in warden:ultimatewarden run damage @s 0 minecraft:player_attack by @p[tag=warden.dungeon]
...
effect give @a[tag=warden.dungeon] darkness 10 3 true
