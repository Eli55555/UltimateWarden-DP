...
execute positioned as @e[type=armor_stand,tag=uw.dungeon.elite_warden.roll] in warden:ultimatewarden if block ~ ~-1 ~ gray_concrete if entity @e[type=warden,tag=elite_warden,limit=1] run function warden:dungeon/boss/fight/slowness_attack/main
