...
execute positioned as @e[type=armor_stand,tag=uw.dungeon.elite_warden.roll] in warden:ultimatewarden if block ~ ~-1 ~ white_concrete if entity @e[type=warden,tag=elite_warden,limit=1] run function warden:dungeon/boss/fight/roll_attack
...
execute positioned as @e[type=armor_stand,tag=uw.dungeon.elite_warden.roll] in warden:ultimatewarden if block ~ ~-1 ~ orange_concrete if entity @e[type=warden,tag=elite_warden,limit=1] run function warden:dungeon/boss/fight/hunt_attack/main
execute positioned as @e[type=armor_stand,tag=uw.dungeon.elite_warden.roll] in warden:ultimatewarden if block ~ ~-1 ~ purple_concrete if entity @e[type=warden,tag=elite_warden,limit=1] run function warden:dungeon/boss/fight/darkness_shield_attack/main
