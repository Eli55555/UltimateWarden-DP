...
data merge storage warden:menu/profile {no_items:{"type": "minecraft:plain_message","contents": {"translate": "ultimate_warden.menu.button.profile.items.no_items","fallback": "You have currently no items","color": "gray"}}}
