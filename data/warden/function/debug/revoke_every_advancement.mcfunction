...
# Statistics
advancement revoke @s only warden:warden/statistics/root
advancement revoke @s only warden:warden/statistics/dungeon_clears/2_clears
advancement revoke @s only warden:warden/statistics/dungeon_clears/5_clears
advancement revoke @s only warden:warden/statistics/dungeon_clears/10_clears
advancement revoke @s only warden:warden/statistics/playtime/1h
advancement revoke @s only warden:warden/statistics/playtime/5h
advancement revoke @s only warden:warden/statistics/playtime/10h
advancement revoke @s only warden:warden/statistics/temple_clears/2_clears
advancement revoke @s only warden:warden/statistics/temple_clears/5_clears
advancement revoke @s only warden:warden/statistics/temple_clears/10_clears
