...
# Offhand
execute unless items entity @s weapon.offhand * run item replace entity @s weapon.offhand with totem_of_undying
...
execute unless items entity @s hotbar.1 * run item replace entity @s hotbar.1 with netherite_pickaxe[enchantments={efficiency:5,unbreaking:3,mending:1}]
execute unless items entity @s hotbar.2 * run item replace entity @s hotbar.2 with netherite_axe[enchantments={sharpness:5,efficiency:5,unbreaking:3,mending:1}]
execute unless items entity @s hotbar.3 * run item replace entity @s hotbar.3 with bow[enchantments={power:4,infinity:1,unbreaking:3,mending:1}]
