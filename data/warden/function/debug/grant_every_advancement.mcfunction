...
# Statistics
advancement grant @s only warden:warden/statistics/root
advancement grant @s only warden:warden/statistics/dungeon_clears/2_clears
advancement grant @s only warden:warden/statistics/dungeon_clears/5_clears
advancement grant @s only warden:warden/statistics/dungeon_clears/10_clears
advancement grant @s only warden:warden/statistics/playtime/1h
advancement grant @s only warden:warden/statistics/playtime/5h
advancement grant @s only warden:warden/statistics/playtime/10h
advancement grant @s only warden:warden/statistics/temple_clears/2_clears
advancement grant @s only warden:warden/statistics/temple_clears/5_clears
advancement grant @s only warden:warden/statistics/temple_clears/10_clears
